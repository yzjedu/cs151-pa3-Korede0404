...
- The random function has too much going on. Please reduce it into smaller functions. 
- The main function have redundant codes in order to have users to input choices, that can be one function. 
- The comments for each function is not appropriate. There is no parameters, purpose or return type. 
